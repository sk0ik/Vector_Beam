...
$$
S' _ 2 = 2Re(\alpha \beta^\ast)\cos{\delta}-2Im(\alpha \beta^\ast)\sin{\delta} = S _ 1\cos{\delta}+S _ 3\sin{\delta} \newline
S' _ 3 = -2Re(\alpha \beta^\ast)\sin{\delta}-2Im(\alpha \beta^\ast)\cos{\delta} = -S _ 1\sin{\delta}+S _ 3\cos{\delta}
$$
...
&= \begin{bmatrix}
S _ 2 \newline
S _ 1\cos{\delta}+S _ 3\sin{\delta} \newline
-S _ 1\sin{\delta}+S _ 3\cos{\delta}
\end{bmatrix}
\newline
