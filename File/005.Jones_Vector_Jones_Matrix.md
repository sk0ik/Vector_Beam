...
- [1/4波長板](#14波長板)
- [直線偏光子](#直線偏光子)
- [表から透過させたあとに裏から透過させると](#表から透過させたあとに裏から透過させると)
- [SLM](#slm)
...
## 表から透過させたあとに裏から透過させると

以上の3つの例に対して $\theta$ 回転させた波長板,直線偏光子に透過させたあとすぐに後ろから透過させるとどうなるでしょうか？表で透過した後,ミラーで反射して裏から透過させます.裏からのときは回転角が $\pi-\theta$ となるので
...
のように回転角 $\theta$ に依存せずx成分を反転する働きをすることが分かります.
