...
電場だけに着目すると水平に振動するものや $\frac{\pi}{4}$ 傾いて振動するものなどがあります.

<div align="center">

| ![GIF1](https://github.com/sk0ik/Vector_Beam/blob/main/GIF/x_polarization.gif) | ![GIF2](https://github.com/sk0ik/Vector_Beam/blob/main/GIF/+45_polarization.gif) |
|:---:|:---:|
| +0度偏光 | +45度偏光 |
...
となり時計回りに $2\theta=45$ 度傾くので $x$ 偏光成分のみになります.

### 表から透過させたあとに裏から透過させる

以上の3つの例に対して $\theta$ 回転させた波長板,直線偏光子に透過させたあとすぐに後ろから透過させるとどうなるでしょうか？表で透過した後,ミラーで反射して裏から透過させます.裏から透過させるときは回転角が $\pi-\theta$ となるので
...
のように回転角 $\theta$ に依存せずx成分を反転する働きをすることが分かります.つまりミラーを抜きにすれば偏光状態をなにも変えないということです
